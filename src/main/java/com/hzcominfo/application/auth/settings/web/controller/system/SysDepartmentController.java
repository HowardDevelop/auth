...
import com.hzcominfo.application.auth.settings.kernel.mapper.SysCodeConfigMapper;
...
import com.hzcominfo.application.auth.settings.web.controller.common.TreeUtilOfDepartment;
import com.hzcominfo.application.auth.settings.web.controller.index.BaseController;
import com.hzcominfo.application.auth.settings.web.rdto.util.DepartmentTreeObject;
...
public class SysDepartmentController extends BaseController implements Runnable {
    ...
    public String editUI(Model model) throws Exception {
        ...
        if (StringUtil.isNotEmpty(id)) {
            ...
            XZQHBFormMap xzqh = xzqhbMapper.findbyFrist("DM", sysDepartment.getStr("xzqh"), XZQHBFormMap.class);
