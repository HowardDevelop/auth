package com.hzcominfo.application.auth.settings.web.logAop;
...
import com.hzcominfo.application.common.util.HtmlUtil;
...
public class LogAopAction {
    ...
    // Controller层切点
    @Pointcut("@annotation(com.hzcominfo.application.common.annotation.SystemLog)")
