...
import com.hzcominfo.application.auth.settings.kernel.entity.SysUserRoleFormMap;
...
import com.hzcominfo.application.auth.settings.web.rdto.system.SysUserBean;
import com.hzcominfo.application.common.annotation.SystemLog;
import com.hzcominfo.application.common.exception.SystemException;
...
import com.hzcominfo.application.common.util.excel.ExcelUtil;
...
public class SysUserController extends BaseController {
    ...
    public String deleteEntity() throws Exception {
        ...
        for (String id : ids1) {
            ...
            sysUserMapper.deleteByAttribute("userId", id, SysUserRoleFormMap.class);
    ...
    public String editEntity(String txtGroupsSelect) throws Exception {
        if (txtGroupsSelect == null || txtGroupsSelect.equals("")) {
            ...
            sysUserMapper.deleteByAttribute("userId", userFormMap.get("userId") + "", SysUserRoleFormMap.class);
            if (!StringUtil.isEmpty(txtGroupsSelect)) {
                String[] txt = txtGroupsSelect.split(",");
                for (String roleId : txt) {
                    SysUserRoleFormMap userGroupsFormMap = new SysUserRoleFormMap();
