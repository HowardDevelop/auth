...
import com.hzcominfo.application.auth.settings.kernel.mapper.XZQHBMapper;
import com.hzcominfo.application.auth.settings.web.controller.common.AttrConstants;
import com.hzcominfo.application.auth.settings.web.controller.common.CodeConfigComponent;
...
//        xzqhbFormMap .put("bdlx", "I");
    ...
    public String deleteEntity() throws Exception {
        ...
        for (String id : ids) {
            xzqhbMapper.deleteByAttribute("dzbm", id, XZQHBFormMap.class);
        }
        return AttrConstants.SUCCESS;
    }
    ...
    public String editUI(Model model) throws Exception {
        ...
        if (StringUtil.isNotEmpty(dzbm)) {
            model.addAttribute("xzqhb", xzqhbMapper.findbyFrist("dzbm", dzbm, XZQHBFormMap.class));
        }
    ...
    public boolean isExistDM(String dm) {
        XZQHBFormMap account = xzqhbMapper.findbyFrist("dm", dm, XZQHBFormMap.class);
        if (account == null) {
            return true;
        } else {
            return false;
    ...
    public boolean isExist(String name) {
        XZQHBFormMap account = xzqhbMapper.findbyFrist("mc", name, XZQHBFormMap.class);
        if (account == null) {
            return true;
        } else {
            return false;
    ...
    public String getXzqhName(String code) throws Exception {
        ...
        XZQHBFormMap xZQHBFormMap = xzqhbMapper.findbyFrist("dm", code, XZQHBFormMap.class);
