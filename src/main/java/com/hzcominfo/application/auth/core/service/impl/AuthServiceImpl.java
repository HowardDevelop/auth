package com.hzcominfo.application.auth.core.service.impl;
...
import com.hzcominfo.application.auth.core.rdto.ApplicationInfo;
import com.hzcominfo.application.auth.core.rdto.DeptmentInfo;
import com.hzcominfo.application.auth.core.rdto.ResponseDto;
import com.hzcominfo.application.auth.core.rdto.RoleInfo;
import com.hzcominfo.application.auth.core.rdto.SystemsettingInfo;
import com.hzcominfo.application.auth.core.rdto.UserInfo;
...
import com.hzcominfo.application.auth.settings.kernel.entity.ApiUserRoleFormMap;
import com.hzcominfo.application.auth.settings.kernel.entity.SysDepartmentFormMap;
import com.hzcominfo.application.auth.settings.kernel.mapper.ApiAccessTokenMapper;
import com.hzcominfo.application.auth.settings.kernel.mapper.ApiLogUserLoginMapper;
import com.hzcominfo.application.auth.settings.kernel.mapper.ApiRoleMapper;
import com.hzcominfo.application.auth.settings.kernel.mapper.ApiSystemInfoMapper;
import com.hzcominfo.application.auth.settings.kernel.mapper.ApiSystemSettingMapper;
import com.hzcominfo.application.auth.settings.kernel.mapper.ApiUserMapper;
import com.hzcominfo.application.auth.settings.kernel.mapper.ApiUserRoleMapper;
import com.hzcominfo.application.auth.settings.kernel.mapper.SysDepartmentMapper;
 ...
 * 
 */
@WebService(targetNamespace = "http://service.core.auth.application.hzcominfo.com/", endpointInterface = "com.hzcominfo.application.auth.core.service.AuthService")
